...
def dibujar_boton_nuevo_desafio(x, y, ancho, alto):
    pygame.draw.rect(pantalla, AZUL, (x, y, ancho, alto))
    fuente = pygame.font.Font(None, 36)
    texto = fuente.render("Nuevo Desafío", True, BLANCO)
...
def juego():
    ...
    boton_nuevo_desafio = dibujar_boton_nuevo_desafio(ANCHO - 200, ALTO - 60, 180, 50)
    ...
    while not fin:
        ...
        # Dibujar botón de nuevo desafío
        boton_nuevo_desafio = dibujar_boton_nuevo_desafio(ANCHO - 200, ALTO - 60, 180, 50)
